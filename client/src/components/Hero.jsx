		...
		<>
			<main
				...
				<section className={Style.colLeft}>
					...
					<h1 className="title">
						Potencia tu podcast con nuestros servicios
						especializados
					</h1>
					<p>
						Te ayudamos a llevar tu idea al siguiente nivel para que
						destaques en el mundo del podcasting
					</p>
					<a className={Style.btn} href="#solicitar">
						Solicitar
					</a>
				</section>
				<section className={`${Style.colRight} ${Style.mask}`}>
